...
class AboutappController extends Controller
{
    ...
    {
        //
        $list = AboutApp::latest()->paginate(10);
        return view('admin.aboutApp.index',compact('list'));
    }
    ...
    {
        //
        $row = AboutApp::find($id);
        return view('admin.aboutApp.show',compact('row'));
    }
    ...
    public function edit($id)
    {
        //
        $row = AboutApp::find($id);
        return view('admin.aboutApp.edit',compact('row'));
    }
