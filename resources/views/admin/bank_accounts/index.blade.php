@extends('admin.layouts.index_layout' , ['title' => __('admin.bank_accounts') ,'route' => 'bank'])

@section('content')

<div class="row">
    <form class="m-form" action="{{url('admin/bank/search')}}" method="get" id="search_form">
