...
<div class="m-portlet">
    ...
    <!--begin::Form-->
    <form class="m-form" action="{{url('admin/category')}}/{{ $category->id }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group m-form__group row {{ $errors->has('name_ar') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <input type="text" name="name_ar" class="form-control m-input" 
                            placeholder="{{ __('admin.name_ar') }}" value="{{ $category->name_ar }}">
            ...
            <div class="form-group m-form__group row {{ $errors->has('name') ? 'has-danger' : ''}}">
                    ...
                    <div class="col-9">
                        <input type="text" name="name" class="form-control m-input" 
                                placeholder="{{ __('admin.name_en') }}" value="{{ $category->name }}">
