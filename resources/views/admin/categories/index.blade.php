@extends('admin.layouts.index_layout' , ['title' => __('admin.categories') ,'route' => 'category'])

@section('content')

<div class="row">
    <form class="m-form" action="{{url('admin/categories/search')}}" method="get" id="search_form">
            ...
            <div class="m-portlet__head">
                ...
                <div class="m-portlet__head-wrapper">
                    ...
                    <div class="m-portlet__head-tools">
                        ...
                        <a href="{{url('admin/category/create')}}" class="btn btn-brand m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
                            <span>
...
<div>
    <a href="{{url('admin/category')}}" class="btn btn-danger m-btn m-btn--icon m-btn--wide">
        <span>
