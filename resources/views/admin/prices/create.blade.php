...
<div class="m-portlet">
 ...
 <!--begin::Form-->
 <form class="m-form" action="{{ config('app.admin_url') }}/prices" method="post" enctype="multipart/form-data">
    ...
    <div class="m-portlet__body">
        ...
        <div class="form-group m-form__group row {{ $errors->has('city_id') ? 'has-danger' : ''}}">
            ...
            <span class="m-form__help form-control-feedback">{{ $errors->first('city_id') }}</span>
        </div>
        ...
        <div class="form-group m-form__group row {{ $errors->has('district_id') ? 'has-danger' : ''}}">
            ...
            <div class="col-4">
                <input type='text' class="form-control" id="m_datepicker_1" readonly placeholder="اختر التاريخ" name="date" />
            </div>
        </div>
        ...
        <div class="form-group m-form__group row {{ $errors->has('first_half_price') ? 'has-danger' : ''}}">
            ...
            <div class="col-9">
                ...
                placeholder="{{ __('admin.first_half') }}" value="{{ old('first_half_price') }}">
        ...
        <div class="form-group m-form__group row {{ $errors->has('second_half_price') ? 'has-danger' : ''}}">
            ...
            <div class="col-9">
                <input class="form-control m-input" placeholder="{{ __('admin.second_half') }}" name="second_half_price" value="{{ old('second_half_price') }}">
