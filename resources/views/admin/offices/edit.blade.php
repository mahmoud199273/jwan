...
<div class="m-portlet">
    ...
    <!--begin::Form-->
    <form class="m-form" action="{{ config('app.admin_url') }}/offices/{{ $office->id }}" method="post" enctype="multipart/form-data">
        ...
        @endif
            ...
            <div class="form-group m-form__group row {{ $errors->has('name') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <input type="text" name="name" class="form-control m-input" 
                            placeholder="{{ __('admin.name') }}" value="{{ $office->name }}">
            ...
            <div class="form-group m-form__group row {{ $errors->has('phone') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <input type="text" class="form-control m-input" 
                            placeholder="{{ __('admin.phone') }}" name="phone" value="{{ $office->phone }}">
            ...
            <div class="form-group m-form__group row {{ $errors->has('email') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <input type="email" class="form-control m-input" 
                            placeholder="{{ __('admin.email') }}" name="email" value="{{ $office->email }}">
            ...
            <div class="form-group m-form__group row {{ $errors->has('office_name') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <input type="text" class="form-control m-input" 
                            placeholder="{{ __('admin.office_name') }}" name="office_name" value="{{ $office->office_name }}">
             ...
             <div class="form-group m-form__group row {{ $errors->has('office_address') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <input type="text" class="form-control m-input" 
                            placeholder="{{ __('admin.office_address') }}" name="office_address" value="{{ $office->office_address }}">
            ...
            <div class="form-group m-form__group row {{ $errors->has('about_name') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <textarea class="form-control m-input" 
                            placeholder="{{ __('admin.about_office') }}" name="about_office">{{ $office->about_office }}</textarea>
