@extends('admin.layouts.index_layout',['title' => __('admin.natoinalities') ])
...
<div class="m-portlet">
        ...
        <div class="m-portlet__head-caption">
            <div class="m-portlet__head-name">
                ...
                <h3 class="m-portlet__head-text">
                   {{ __('admin.add') }} | {{ __('admin.natoinality') }}
                </h3>
            </div>
        </div>
    </div>
    ...
    <!--begin::Form-->
    <form class="m-form" action="{{url('admin/natoinality')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="m-form__actions m-form__actions--solid">
                <div class="row">
                    ...
                    <div class="col-9">
                        ...
                        <a type="reset" href="{{url('admin/natoinality')}}" class="btn btn-secondary">{{ __('admin.cancel') }}</a>
                    </div>
                </div>
            </div>
        </div>
