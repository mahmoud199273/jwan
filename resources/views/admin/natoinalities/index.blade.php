@extends('admin.layouts.index_layout' , ['title' => __('admin.natoinalities') ,'route' => 'natoinality'])

@section('content')

<div class="row">
    <form class="m-form" action="{{url('admin/Natoinalities/search')}}" method="get" id="search_form">
        ...
        <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <h3 class="m-portlet__head-text">
                                {{ __('admin.natoinalities') }}  
                            </h3>
                        </div>
                    </div>
                    <div class="m-portlet__head-tools">

                        <a href="{{url('admin/natoinality/create')}}" class="btn btn-brand m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
                            <span>
            ...
            <div> 
                <span>
                    ...
                    {{$rows->currentpage()*$rows->perpage()}}
                </span> 
                <span>{{ __('admin.from') }}</span>
                <span class="badge badge-info">{{ $rows->total() }}</span>
...
<div>
    <a href="{{url('admin/natoinality')}}" class="btn btn-danger m-btn m-btn--icon m-btn--wide">
        <span>
