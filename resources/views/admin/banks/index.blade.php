...
<div class="row">
    <form class="m-form" action="{{ config('app.admin_url') }}/banks/search" method="get" id="search_form">
...
<div>
    <a href="{{ config('app.admin_url') }}/bank" class="btn btn-danger m-btn m-btn--icon m-btn--wide">
        <span>
