@extends('admin.layouts.index_layout' , ['title' => __('admin.countries') ,'route' => 'country'])

@section('content')

<div class="row">
    <form class="m-form" action="{{url('admin/countries/search')}}" method="get" id="search_form">
        ...
        <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
            <div class="m-portlet__head">
                ...
                <div class="m-portlet__head-wrapper">
                    ...
                    <div class="m-portlet__head-tools">
                        ...
                        <a href="{{url('admin/country/create')}}" class="btn btn-brand m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
                            <span>
            ...
            <div> 
                <span>
                    ...
                    {{($countries->currentpage()-1)*$countries->perpage()+1}} 
                    <span>{{ __('admin.to') }}</span> 
                    {{$countries->currentpage()*$countries->perpage()}}
                </span> 
                <span>{{ __('admin.from') }}</span>
                <span class="badge badge-info">{{ $countries->total() }}</span>
...
<div>
    <a href="{{url('admin/country')}}" class="btn btn-danger m-btn m-btn--icon m-btn--wide">
        <span>
