...
<div class="m-portlet">
    ...
    <!--begin::Form-->
    <form class="m-form" action="{{ config('app.admin_url') }}/packages/{{ $package->id }}" method="post" enctype="multipart/form-data">
        ...
        @endif
            ...
            <div class="form-group m-form__group row {{ $errors->has('title') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <input type="text" name="title" class="form-control m-input" 
                            placeholder="{{ __('admin.title') }}" value="{{ $package->title }}">
            ...
            <div class="form-group m-form__group row {{ $errors->has('price') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <input type="text" class="form-control m-input" 
                            placeholder="{{ __('admin.price') }}" name="price" value="{{ $package->price }}">
            ...
            <div class="form-group m-form__group row {{ $errors->has('period') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <input type="number" class="form-control m-input" 
                            placeholder="{{ __('admin.period') }}" name="period" value="{{ $package->period }}">
            ...
            <div class="form-group m-form__group row {{ $errors->has('number_of_featured_ads') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <input type="text" class="form-control m-input" 
                            placeholder="{{ __('admin.number_of_featured_ads') }}" name="number_of_featured_ads" value="{{ $package->number_of_featured_ads }}">
            ...
            <div class="form-group m-form__group row {{ $errors->has('number_of_normal_ads') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <input type="text" class="form-control m-input" 
                            placeholder="{{ __('admin.number_of_normal_ads') }}" name="number_of_normal_ads" value="{{ $package->number_of_normal_ads }}">
