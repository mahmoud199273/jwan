        ...
        @endif
            ...
            <div class="form-group m-form__group row {{ $errors->has('status') ? 'has-danger' : ''}}" disabled="">
                ...
                <select name="status"  class="form-control m-input" disabled>
                   <option value="0" {{ $offer->status == 0? "selected" : "" }} > 0</option>
                   <option value="1" {{ $offer->status == 1? "selected" : "" }} > 1</option>
                   <option value="2" {{ $offer->status == 2? "selected" : "" }} > 2</option>
                   <option value="3" {{ $offer->status == 3? "selected" : "" }} > 3</option>
                   <option value="4" {{ $offer->status == 4? "selected" : "" }} > 4</option>
                   <option value="5" {{ $offer->status == 5? "selected" : "" }} > 5</option>
                   <option value="6" {{ $offer->status == 6? "selected" : "" }} > 6</option>
                   <option value="7" {{ $offer->status == 7? "selected" : "" }} > 7</option>
