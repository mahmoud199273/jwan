...
<div class="m-portlet">
        ...
        <div class="m-portlet__head-caption">
            <div class="m-portlet__head-title">
                ...
                <h3 class="m-portlet__head-text">
                   {{ __('admin.add') }} | {{ __('admin.services') }}
                </h3>
            </div>
        </div>
    </div>
    ...
    <!--begin::Form-->
    <form class="m-form" action="{{ config('app.admin_url') }}/services" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group m-form__group row {{ $errors->has('body') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <input type="text" class="form-control m-input" 
                            placeholder="{{ __('admin.body') }}" name="body" value="{{ old('body') }}">
