...
<div class="m-portlet">
    ...
    <!--begin::Form-->
    <form class="m-form" action="{{ config('app.admin_url') }}/cities/{{ $area->id }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group m-form__group row {{ $errors->has('name_ar') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <input type="text" name="name_ar" class="form-control m-input" 
                            placeholder="{{ __('admin.name_ar') }}" value="{{ $area->name_ar }}" disabled="">
            ...
            <div class="form-group m-form__group row {{ $errors->has('name') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <input type="text" name="name" class="form-control m-input" 
                            placeholder="{{ __('admin.name_en') }}" value="{{ $area->name }}" disabled="">
