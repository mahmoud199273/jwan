@extends('admin.layouts.index_layout' , ['title' => __('admin.areas') ,'route' => 'area'])
        ...
        <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
            <div class="m-portlet__head">
                ...
                <div class="m-portlet__head-wrapper">
                    ...
                    <div class="m-portlet__head-tools">
                        ...
                        <a href="{{url('admin/area/create')}}" class="btn btn-brand m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
                            <span>
            ...
            <div> 
                <span>
                    ...
                    {{($areas->currentpage()-1)*$areas->perpage()+1}} 
                    <span>{{ __('admin.to') }}</span> 
                    {{$areas->currentpage()*$areas->perpage()}}
                </span> 
                <span>{{ __('admin.from') }}</span>
                <span class="badge badge-info">{{ $areas->total() }}</span>
...
<div>
    <a href="{{url('admin/area')}}" class="btn btn-danger m-btn m-btn--icon m-btn--wide">
        <span>
