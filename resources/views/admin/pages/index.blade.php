@extends('admin.layouts.index_layout' , ['title' => __('admin.pages') ,'route' => 'pages'])

@section('content')

<div class="row">
    <form class="m-form" action="{{url('admin/page/search')}}" method="get" id="search_form">
    ...
    <div class="col-lg-12">
        ...
        <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile" id="main_portlet">
            ...
            <div> 
                ...
                <span class="badge badge-info">{{ $pages->total() }}</span>
...
<div>
    <a href="{{url('admin/pages')}}" class="btn btn-danger m-btn m-btn--icon m-btn--wide">
        <span>
