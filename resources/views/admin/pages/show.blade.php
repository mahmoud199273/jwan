@extends('admin.layouts.index_layout',['title' => __('admin.pages') ])
...
<div class="m-portlet">
    ...
    <!--begin::Form-->
    <form class="m-form" action="{{ config('app.admin_url') }}/cities/{{ $page->id }}" method="post" enctype="multipart/form-data">
        ...
        @endif
            ...
            <div class="form-group m-form__group row {{ $errors->has('name_ar') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <input type="text" name="name_ar" class="form-control m-input" 
                            placeholder="{{ __('admin.name_ar') }}" value="{{ $page->name_ar }}" disabled="">
            ...
            <div class="form-group m-form__group row {{ $errors->has('name') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <input type="text" name="name" class="form-control m-input" 
                            placeholder="{{ __('admin.name_en') }}" value="{{ $page->name }}" disabled="">
            ...
            <div class="form-group m-form__group row {{ $errors->has('desc_ar') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <textarea class="form-control m-input" placeholder="{{ __('admin.description_ar') }}" name="desc_ar" disabled>{{ $page->desc_ar }}</textarea>
            ...
            <div class="form-group m-form__group row {{ $errors->has('desc') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <textarea class="form-control m-input" placeholder="{{ __('admin.description') }}" name="desc" disabled>{{ $page->desc }}</textarea>
        ...
        <div class="m-portlet__foot m-portlet__foot--fit">
            <div class="m-form__actions m-form__actions--solid">
                <div class="row">
                    ...
                    <div class="col-9">
                        <a type="reset" href="{{url('admin/pages')}}" class="btn btn-secondary">{{ __('admin.cancel') }}</a>
                    </div>
                </div>
            </div>
        </div>
