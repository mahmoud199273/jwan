...
<div class="m-portlet">
    ...
    <!--begin::Form-->
    <form class="m-form" action="{{url('admin/pages')}}/{{ $page->id }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group m-form__group row {{ $errors->has('name_ar') ? 'has-danger' : ''}}">
            ...
            <div class="col-9">
                <input type="text" name="name_ar" class="form-control m-input" 
                        placeholder="{{ __('admin.name_ar') }}" value="{{ $page->name_ar }}" >
        ...
        <div class="form-group m-form__group row {{ $errors->has('name') ? 'has-danger' : ''}}">
            ...
            <div class="col-9">
                <input type="text" name="name" class="form-control m-input" 
                        placeholder="{{ __('admin.name_en') }}" value="{{ $page->name }}" >
        ...
        <div class="form-group m-form__group row {{ $errors->has('desc_ar') ? 'has-danger' : ''}}">
            ...
            <div class="col-9">
                <textarea class="form-control m-input" placeholder="{{ __('admin.description_ar') }}" name="desc_ar" >{{ $page->desc_ar }}</textarea>
        ...
        <div class="form-group m-form__group row {{ $errors->has('desc') ? 'has-danger' : ''}}">
            ...
            <div class="col-9">
                <textarea class="form-control m-input" placeholder="{{ __('admin.description') }}" name="desc" >{{ $page->desc }}</textarea>
